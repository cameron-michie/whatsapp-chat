export const handler = async (event) => {
  try {
    ...
    for (const rawMessage of messages) {
      ...
      console.log(`Channel: ${channel}, Room ID: ${roomId}`);
      ...
      if (recipients.length > 0) {
        await updateRecipientsSimple(recipients, roomId, messageText, clientId);
      }
    }
...
async function updateRecipientsSimple(recipients, roomId, messageText, senderId) {
